...
export interface ApiCustomerCustomer extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Customers captured from checkout';
...
export interface ApiDiscountDiscount extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Checkout discounts managed from the CMS';
...
export interface ApiFaqFaq extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    faqResponse: Schema.Attribute.Blocks;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiFeaturedProductFeaturedProduct
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    featuredProductBottomButtonHref: Schema.Attribute.String;
    featuredProductBottomButtonLabel: Schema.Attribute.String;
    featuredProductLimit: Schema.Attribute.Integer;
    featuredProductNotProductsText: Schema.Attribute.String;
    featuredProductTitle: Schema.Attribute.String;
    featuredProductTopButtonHref: Schema.Attribute.String;
    featuredProductTopButtonLabel: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiFooterFooter extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    footerBusinessName: Schema.Attribute.String;
    footerFacebookLink: Schema.Attribute.String;
    footerInstagramLink: Schema.Attribute.String;
    footerMessageUnderBusinessName: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::footer.footer'
    ...
    publishedAt: Schema.Attribute.DateTime;
    termConditions: Schema.Attribute.Blocks;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiGlobalGlobal extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    favicon16: Schema.Attribute.Media<'images' | 'files'>;
    favicon32: Schema.Attribute.Media<'images' | 'files'>;
    faviconIco: Schema.Attribute.Media<'images' | 'files'>;
    icon192: Schema.Attribute.Media<'images' | 'files'>;
    icon512: Schema.Attribute.Media<'images' | 'files'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::global.global'
...
export interface ApiOrderOrder extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Persisted orders created during checkout';
    displayName: 'Order';
    pluralName: 'orders';
    singularName: 'order';
  };
  ...
  attributes: {
    ...
    shippingOptionId: Schema.Attribute.String;
    status: Schema.Attribute.Enumeration<
      ['pending', 'processing', 'paid', 'failed', 'cancelled']
    > &
      Schema.Attribute.DefaultTo<'pending'>;
    subtotal: Schema.Attribute.Decimal & Schema.Attribute.DefaultTo<0>;
    taxableSubtotal: Schema.Attribute.Decimal & Schema.Attribute.DefaultTo<0>;
...
export interface ApiProductAttributeValueProductAttributeValue
  ...
  info: {
    displayName: 'ProductAttributeValue';
...
export interface ApiProductAttributeProductAttribute
  ...
  attributes: {
    ...
    products: Schema.Attribute.Relation<'manyToMany', 'api::product.product'>;
    publishedAt: Schema.Attribute.DateTime;
    type: Schema.Attribute.Enumeration<['color', 'package', 'other']>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiPromoBannerPromoBanner extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    promoActive: Schema.Attribute.Boolean;
...
export interface ApiShippingOriginShippingOrigin
  ...
  info: {
    description: 'Origin locations used for shipping quotes and storefront display';
    displayName: 'Shipping Origin';
...
export interface ApiTaxTax extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::tax.tax'> &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    taxActive: Schema.Attribute.Boolean;
    taxName: Schema.Attribute.String;
    taxPercent: Schema.Attribute.Decimal;
    taxState: Schema.Attribute.Enumeration<['FL']>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
