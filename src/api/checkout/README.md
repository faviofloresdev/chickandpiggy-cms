...
- `RESEND_SHIPPING_TEMPLATE_ID` (optional): published Resend template id/alias for shipping notifications. When omitted, the branded HTML/text template bundled with the backend is used.
